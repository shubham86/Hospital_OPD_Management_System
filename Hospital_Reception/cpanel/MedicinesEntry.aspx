<%@ Page Title="" Language="C#" MasterPageFile="../cpanel/MasterCP.Master" AutoEventWireup="true" CodeBehind="MedicinesEntry.aspx.cs" Inherits="Hospital_Reception.cpanel.MedicinesEntry" %>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-8 col-sm-12 mobile-hide">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">Medicines Entry</li>
                </ul>
            </div>
        </div>
    </div>    
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header mobile-hide">
                        <h2><strong>Medicines</strong> Entry</h2>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-8 align-center ">
                                <div class="form-group ">
                                    <input  type="text" id="txtName" class="form-control" placeholder="Full Name" required="required" style="text-align: center" runat="server" onfocusout="fetchDetails()">
                            ...
                            <div class="card patients-list body">
                                <div class="tab-content m-t-10">
                                    <div class="tab-pane table-responsive active" id="All">
                                        <table class="table table-hover js-basic-example dataTable" style="border-collapse: collapse">
                                            <thead>                                               
                                                <tr>
                                                    ...
                                                    <th class="align-center">Medicine Name</th>
                                                    <th class="align-center">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <asp:Repeater ID="rptrMedicines" runat="server" OnItemCommand="rptrMedicines_RowCommand">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="align-center">
                                                                <asp:Label ID="lblName" runat="server" Text='<%# Eval("medicineName") %>'></asp:Label></td>                                                      
                                                          <td class="align-center">
                                                                <asp:LinkButton ID="btnDelete" runat="server" CssClass="btnStatus btnAbsent"  CommandArgument='<%# Eval("medicineID") %>' CommandName="delete" Text="Delete" />
                                                                <asp:LinkButton ID="btnEdit" runat="server" CssClass="btnStatus btnEdit" Text="Edit" CommandArgument='<%# Eval("medicineID") + ";" + Eval("medicineName")%>' CommandName="edit" />
                                                            </td>                                                          
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                        ...
                                        <asp:Label ID="lblMedicineID" runat="server" Text="0" ForeColor="White" Font-Size="1"></asp:Label>                                             
                                    </div>
                                </div>
                            </div>
                        </div>
