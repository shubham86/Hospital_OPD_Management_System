<%@ Page Title="" Language="C#" MasterPageFile="../cpanel/MasterCP.Master" AutoEventWireup="true" CodeBehind="OurPatient.aspx.cs" Inherits="Hospital_Reception.cpanel.OurPatient" %>
                ...
                <div class="card">
                    <div class="body" style="padding-top: 0">
                        <div class="header mobile-hide">
                            <h2>Our <strong>Patients</strong></h2>
                        </div>
                        <div class="row clearfix">
                                ...
                                <div class="tab-content m-t-10">
                                    <div class="tab-pane table-responsive active" id="All">
                                        <table class="table table-hover js-basic-example dataTable" style="border-collapse: collapse">
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rptrPatient" runat="server" OnItemCommand="rptrAdmin_RowCommand">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="align-center">
                                                                <asp:Label ID="lblName" runat="server" Text='<%# Eval("Patient Name") %>'></asp:Label></td>
                                                            <td class="align-center">
                                                            ...
                                                            <%--<td class="align-center">
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btnStatus btnEdit" Text="History" CommandArgument='<%# Eval("adminID") %>' CommandName="history" />                                                      
                                                            </td>--%>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
